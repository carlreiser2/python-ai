...
-- Started on 2024-05-03 17:51:15 EDT
...
DROP DATABASE pgvec_g4a_m1;
--
-- TOC entry 3855 (class 1262 OID 170311)
-- Name: pgvec_g4a_m1; Type: DATABASE; Schema: -; Owner: -
--

CREATE DATABASE pgvec_g4a_m1 WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = icu LOCALE = 'en_US.UTF-8' ICU_LOCALE = 'en-US';


\connect pgvec_g4a_m1
...
--
-- TOC entry 264 (class 1255 OID 420336)
-- Name: subbet_metadata_log(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- TOC entry 240 (class 1255 OID 671327)
-- Name: subbets_ext__delete_existing_id(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- TOC entry 238 (class 1259 OID 671441)
-- Name: foreign__subbets; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.foreign__subbets (
);


--
-- TOC entry 220 (class 1259 OID 244274)
-- Name: games_ext; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 217 (class 1259 OID 195175)
...
--
-- TOC entry 218 (class 1259 OID 195184)
...
--
-- TOC entry 230 (class 1259 OID 420399)
-- Name: langchain_pg_embedding__gms__g4a; Type: VIEW; Schema: public; Owner: -
--
...
--
-- TOC entry 231 (class 1259 OID 420403)
-- Name: langchain_pg_embedding__pta__g4a; Type: VIEW; Schema: public; Owner: -
--
